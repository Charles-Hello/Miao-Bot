...
//)
//
//func TQPlugin[T any](msgBody *ihttp.PostBody) {
...
//		var body ihttp.PostBody
//		if msgBody.Event == ihttp.EventGroupMsg {
//			// 艾特回复
//			body = ihttp.BuildSendGroupMsgAndAt("\n"+weather, msgBody.FromWxId,
//				msgBody.FinalFromWxId, msgBody.FinalFromName)
//
//		} else if msgBody.Event == ihttp.EventFriendMsg {
//			body = ihttp.BuildSendTextMsgBody(weather, msgBody.FromWxId)
//		}
